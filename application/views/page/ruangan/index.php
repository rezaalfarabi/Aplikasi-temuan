...
<div class="row py-1">
	<div class="col s12 m7">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?= base_url('edit-ruangan/'.$isi->id_ruangan) ?>"
										class="btn-floating btn-sm"><i class="material-icons">edit</i></a>
									<a href="<?= base_url('hapus-ruangan/'.$isi->id_ruangan) ?>"
		...
		<div class="fixed-action-btn">
			<a href="<?= base_url('tambah-ruangan') ?>" class="btn-floating btn-large blue">
