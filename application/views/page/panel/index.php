...
<div class="row py-1">
	<div class="col s12 m7">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="<?= base_url('edit-panel/'.$isi->id_panel) ?>"
										class="btn-floating btn-sm"><i class="material-icons">edit</i></a>
									<a href="<?= base_url('hapus-panel/'.$isi->id_panel) ?>"
		...
		<div class="fixed-action-btn">
			<a href="<?= base_url('tambah-panel') ?>" class="btn-floating btn-large blue">
